package com.example.ruzn_calculator
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonMultipluy : Button = findViewById(R.id.button_multiply)
        ...
        val buttons = listOf(buttonClear,buttonBracketLeft,buttonBracketRight,button0,button1,
            button2,button3,button4,button5,button6,button7,button8,button9,buttonDot,
            buttonDivision,buttonMultipluy,buttonSubstraction,buttonAddition
        )
    ...
    private fun showResult() {
        val outputText: TextView = findViewById(R.id.input)
        try{
